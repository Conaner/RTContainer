...
const char rtems_test_name[] = "CGTEST5-3 CPU QUOTA";
...
rtems_task Init( rtems_task_argument ignored )
{
  ...
  printf(
    "[Ticks:%" PRIu64 "] All %d tasks finished across %d cgroups in CGTEST5-3\n",
    current_ticks(),
    TEST_TASK_COUNT,
    TEST_CGROUP_COUNT
  );
